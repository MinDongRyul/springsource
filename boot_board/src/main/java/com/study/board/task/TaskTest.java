...
public class TaskTest {
	...
	// "* * * * * *" : 초, 분, 시, 일, 월 ,요일 ,연도
	// "0 0 * * * *" : 매일, 매시 정각
	// @Scheduled(fixedDelay="") : 이전에 실행된 Task의 종료 시간으로 부터 정의된 시간만큼 지난 후 task 실행
	// @Scheduled(fixedRate="")  : 이전에 실행된 Task의 시작 시간으로 부터 정의된 시간만큼 지난 후 task 실행
